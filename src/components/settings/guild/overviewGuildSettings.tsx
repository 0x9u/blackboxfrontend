...
const OverviewGuildSettings: FC = () => {
  ...
  return (
    <form onChange={(e) => setFormEdited(true)} className="relative h-full">
      ...
      <div className={`fixed w-[620px] bg-shade-2 ${formEdited ? "-translate-y-4": "translate-y-16"} bottom-0 h-12 transition duration-200 rounded-md text-white px-4 flex flex-row`}>
